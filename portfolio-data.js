/* Auto-generated by CMS server — do not edit */
window.__PORTFOLIO_DATA__ = {
  ...
  "footer": {
    "copyright": "© 2026 Andrian Guruh· IT Project Manager & Website Specialist."
  },
  "profile": {
    "name": "Andri",
    "titleTag": "IT Project Manager - Web Specialist",
    "cmsBadge": "-",
    "cmsTitle": "Admin Portal",
    "cmsSubtitle": "Real-Time Content Synchronizer · Andri Portfolio"
  },
  "hero": {
  ...
  "workflow": [
    {
      ...
      "desc": "Stakeholder alignment, backlog story grooming, and success metric definition."
    },
    {
      "num": "02",
      "title": "Architecture",
      "desc": "Selecting web frameworks, database schemas, and API integration contracts."
    },
    {
      "num": "03",
      "title": "Agile Sprints",
      "desc": "2-week iterative sprints, daily standups, and continuous code integration."
    },
    {
      "num": "04",
      "title": "QA & UAT",
      "desc": "Security audit hardening, automated regression, and User Acceptance sign-off."
    },
    {
      "num": "05",
      "title": "Launch & Value",
      "desc": "Production release, analytics tracking, and continuous post-launch optimization."
    }
  ],
  "contact": {
  ...
  "projects": [
    ...
    },
    {
      ...
      "metrics": [
        {
          "label": "Test-Drive Leads",
          "value": "+215%"
        },
        {
          "label": "Showroom Dwell Time",
          "value": "4m 12s"
        },
        {
    ...
    },
    {
      ...
      "techStack": [
        ...
        "PostgreSQL",
        "Digital Signatures (BSRE)",
        "Vue.js",
        "Audit Logging"
      ],
      "metrics": [
        {
          "label": "Grant Volume Processed",
          "value": "$45M+"
        },
        {
